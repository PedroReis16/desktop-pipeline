...
<xsl:stylesheet version="1.0" 
 ...
 xmlns:wix="http://wixtoolset.org/schemas/v4/wxs">
  ...
  <xsl:key name="ExeComponentId" 
           match="wix:Component[wix:File[@Source='$(var.PublishDir)\Desktop.Instance.exe']]" 
           use="@Id" />

  <!-- 3. Remove o Componente que contém o arquivo EXE -->
  <xsl:template match="wix:Component[wix:File[@Source='$(var.PublishDir)\Desktop.Instance.exe']]" />
